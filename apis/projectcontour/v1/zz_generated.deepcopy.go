...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HeaderAlterations) DeepCopyInto(out *HeaderAlterations) {
	*out = *in
	if in.Add != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HeaderAlterations.
func (in *HeaderAlterations) DeepCopy() *HeaderAlterations {
	if in == nil {
		return nil
	}
	out := new(HeaderAlterations)
	in.DeepCopyInto(out)
	return out
}
